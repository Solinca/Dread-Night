...
{ 
	...
	if (ItemDataAsset->Type.MatchesTag(GT_Item_Armor))
		NewItem = NewObject<UItemInstance_Armor>();
	if (ItemDataAsset->Type.MatchesTag(GT_Item_Food))
		NewItem = NewObject<UItemInstance_Food>();
	if (ItemDataAsset->Type.MatchesTag(GT_Item_Drink))
		NewItem = NewObject<UItemInstance_Drink>();

	
	if (ItemDataAsset->Type.MatchesTag(GT_Item))
